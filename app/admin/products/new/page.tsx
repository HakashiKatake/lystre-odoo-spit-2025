                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-white border-2 border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                            <div className="p-4 border-b-2 border-black bg-gray-50">
                                <h3 className="font-bold text-lg font-serif">Product Details</h3>
                            </div>
                            <div className="p-6 space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        {errors.category && <p className="text-red-500 text-sm mt-1 font-bold">{errors.category}</p>}
                                    </div>

                                    <div>
                                        <Label className="text-black font-bold">Product Type *</Label>
                                        <select
                                            value={formData.type}
                                            onChange={(e) => {
                                        ...
                                        {errors.type && <p className="text-red-500 text-sm mt-1 font-bold">{errors.type}</p>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {errors.material && <p className="text-red-500 text-sm mt-1 font-bold">{errors.material}</p>}
                                    </div>
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        {errors.colors && <p className="text-red-500 text-sm mt-1 font-bold">{errors.colors}</p>}
                                    </div>
                        ...
                        <div className="bg-white border-2 border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                            ...
                            <div className="p-6">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <Label className="text-black font-bold">Sales Price (₹) *</Label>
                                        <Input
                                            type="number"
                                        ...
                                        />
                                        {errors.salesPrice && <p className="text-red-500 text-sm mt-1 font-bold">{errors.salesPrice}</p>}
                                    </div>

                                    <div>
                                        <Label className="text-black font-bold">Sales Tax (%)</Label>
                                        <Input
                                            type="number"
                                    ...
                                    <div>
                                        <Label className="text-black font-bold">Purchase Price (₹)</Label>
                                        <Input
                                            type="number"
                                    ...
                                    <div>
                                        <Label className="text-black font-bold">Purchase Tax (%)</Label>
                                        <Input
                                            type="number"
