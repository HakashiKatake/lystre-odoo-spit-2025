        ...
        <div className="space-y-6 animate-fade-in">
            ...
            {filteredOrders.length > 0 ? (
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {order.status === "CONFIRMED" && (
                                                <Button
                                                    variant="ghost"
                                                    size="icon"
                                                    className="h-8 w-8 text-lystre-brown hover:bg-orange-50 border-2 border-transparent hover:border-black transition-all"
                ...
                <div className="bg-white border-2 border-black p-16 rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center">
                    ...
                    <h2 className="text-xl font-bold font-serif mb-2">No sale orders found</h2>
