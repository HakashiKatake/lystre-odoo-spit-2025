                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            <h1 className="text-2xl font-bold font-serif">{invoice.invoiceNumber}</h1>
                    ...
                    <div className="bg-white border-2 border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div>
                                    <p className="text-sm text-gray-500 font-bold">Invoice Number</p>
                                    <p className="font-medium">{invoice.invoiceNumber}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500 font-bold">Invoice Date</p>
                                ...
                                <div>
                                    ...
                                    {invoice.order ? (
                                        <Link href={`/admin/sale-orders/${invoice.order.id}`} className="font-medium text-[#A1887F] hover:underline">
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {invoice.items?.map((item) => (
                                        <TableRow key={item.id} className="border-b border-black/10 hover:bg-gray-50/50">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white border-2 border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                        ...
                        <div className="p-6 space-y-2 text-sm">
                            ...
                            {invoice.customer.email && <p className="font-medium text-gray-700">{invoice.customer.email}</p>}
