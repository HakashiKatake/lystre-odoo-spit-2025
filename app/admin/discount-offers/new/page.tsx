  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold">New Discount Offer</h1>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Generate Coupons (Optional)</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                ...
                <div>
                  <Label htmlFor="expirationDate">Coupon Expiration Date</Label>
                  <Input
                    id="expirationDate"
                    type="date"
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-green-600">{formData.discountPercentage}% off</p>
                </div>
                <div>
                ...
                <hr />
                <div>
                  <p className="text-sm text-muted-foreground">Coupons to Generate</p>
                  <p className="font-medium">
                    {generateOptions.forType === 'anonymous' 
